...
export type StarterEggMoveSet = [MoveId, MoveId, MoveId, MoveId];

export interface StarterCustomPassives {
  [speciesId: number]: {
    [formIndex: number]: AbilityId;
  };
}
...
export interface StarterDataEntry {
  ...
  /** Player-customized egg move slots for this starter (offline personal mode) */
  customEggMoves?: StarterEggMoveSet;
  /** Player-customized passives keyed by species and form index */
  customPassives?: StarterCustomPassives;
}
